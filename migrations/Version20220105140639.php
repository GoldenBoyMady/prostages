 ...
 */
final class Version20220105140639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, id_entreprise_id INT NOT NULL, titre VARCHAR(255) NOT NULL, mission LONGTEXT NOT NULL, INDEX IDX_C27C93691A867E8F (id_entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
